...
TEST(capi, execute)
{
    ...
    */
    ...
    EXPECT_THAT(fizzy_execute(instance, 0, nullptr, 0, 0), Result());
    EXPECT_THAT(fizzy_execute(instance, 1, nullptr, 0, 0), Result(42));
    FizzyValue args[] = {{42}, {2}};
    EXPECT_THAT(fizzy_execute(instance, 2, args, 2, 0), Result(21));
    EXPECT_THAT(fizzy_execute(instance, 3, nullptr, 0, 0), Traps());
...
TEST(capi, execute_with_host_function)
{
    ...
    */
    ...
    EXPECT_THAT(fizzy_execute(instance, 0, nullptr, 0, 0), Result(42));

    FizzyValue args[] = {{42}, {2}};
    EXPECT_THAT(fizzy_execute(instance, 1, args, 2, 0), Result(21));
...
TEST(capi, imported_function_traps)
{
    ...
    */
    ...
    EXPECT_THAT(fizzy_execute(instance, 1, nullptr, 0, 0), Traps());
...
TEST(capi, imported_function_void)
{
    ...
    */
    ...
    EXPECT_THAT(fizzy_execute(instance, 1, nullptr, 0, 0), Result());
    EXPECT_TRUE(called);
...
TEST(capi, imported_function_from_another_module)
{
    ...
    */
    ...
    EXPECT_THAT(fizzy_execute(instance2, 1, args, 2, 0), Result(42));
